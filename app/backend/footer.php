...
<?php /*<!-- 				<a href="#this" id="get-footer-popup">Заказать обратный звонок</a>
...
<div class="overlay">
	<div class="col-md-4 l--first-screen__modal-form">
		<form id="modal-form" method="POST" action="mailer.php"><?php include 'modules/form.php';?></form>
	</div>
</div>
<?php /*<div class="mail-popup">
...
<?php /*<!-- <script src="https://use.fontawesome.com/b3c61977a6.js"></script> -->*/?>
